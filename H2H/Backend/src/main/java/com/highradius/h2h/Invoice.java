...
public class Invoice {
	...
	public String toString() {
		return "Invoice [id=" + id + ", business_code=" + business_code + ", cust_number=" + cust_number
				...
				+ ", invoice_id=" + invoice_id + ", isOpen=" + isOpen + ", name_customer=" + name_customer
				+ ", business_name=" + business_name + ", aging_bucket=" + aging_bucket + "]";
	}
